...
<div id="left"><h2>suppliers that are selected as winner</h2>
<div>
<?php		
...
$sql3="select *from supplier where status='registered' && total_price =(SELECT MIN(total_price) 
FROM supplier where status='registered') && supplier_sex='male'";
