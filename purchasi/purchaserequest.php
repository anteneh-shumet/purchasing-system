...
<option value="college_director">college-dean</option>
</select>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><button type="submit" name="insert">request</button>
...
$result=mysqli_query($connection,$sql2) ;
			      ...
			      If($result)echo "<font color='green' size='5'>purchasing request is submitted!</font>";
