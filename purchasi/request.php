...
<div id="right">
  ...
  <button class="dropbtn1" font-size="200px">offices</button><br
 <div class="dropdown-content1" style="down:0;">
<a href="request.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;request purchasing </a><br><hr><br>
 <a href="registeringmodel20.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;register model20 </a><br><hr><br>
  <a href="viewdirectoratenotice.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;view directorate notices </a><br><hr><br>
 <a href="officeupdateaccount.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;update your account </a><br>
</div>
<div id="left"><div>
<form id="form"action="request.php" method="post" form name="f1" align="center">
	<fieldset>
<legend align="center"><h2>purchasing request submission form</h2></legend><br>
&nbsp;item_type:<input type="text" name="item_type" placeholder="enter item type"pattern="[a-zA-Z0-9]+" required />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sent-frome:<select name="sent_from"required="true"  pattern="[A-Z a-z]+" >
<option value="offices">offices</option>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status:<select name="status"><option>send</option></select><br><br>

specification:<textarea type="text" name="specification" placeholder="enter  items specification"pattern="[a-zA-Z0-9]+" required ></textarea>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;office_id:<input type="text" name="officce_id" placeholder="enter office number"pattern="[a-zA-Z0-9]+" required /><br><br>
item_quantity:<input type="text" name="item_quantity" placeholder="enter item quantity"pattern="[0-9]+" required />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;department:<select name="dept_name"required="true"  pattern="[A-Z a-z]+" ><br>
