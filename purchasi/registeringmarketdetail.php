...
If($result)
			echo "<font color='green' size='5'>market detail registered successfully! </font>";
		else
 die("<font color='red' size='5'>unable to register market detail! </font>".mysqli_error($connection));
		}  else
