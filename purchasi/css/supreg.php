...
<html>
	<head>
		...
		<titlesuplier registration</title>
	...
	<body>
		<div id="templatemo_wrapper">
	     ...
	     <div id="left">
			         ...
			         <fieldset>
<legend align="center"><h2 class="style12"> Suplier Registration Form</h2></legend>  
         <div id="content-slider" class="b">
    	<div id="slider" style="float:left">
        	<div id="mask">

		<form><br>
			<b>First-Name:&nbsp;&nbsp;&nbsp;</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="" >
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<b>Last-Name:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="" >
				<br><br><b>Company-Name:&nbsp;&nbsp;&nbsp;&nbsp;</b><input type="text" value="" >
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<b>Supplier_Sex:</b><input type="radio" name="supplier_sex" value="male"/> Male
                 <input type="radio" name="supplier_sex"  value="female"/> Female&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 <br><br><b> Country:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="role"required="true"><br>
				 ...
				 <br><br><b>Phone:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="supplier_phone" pattern="[09]{2}[0-9]{8}" required id="phone" />
				   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				   <b>Email:</b><input type="text" id="email" name="email" required=""  />
				 <br><br><b>Vat Number:</b><input type="text" name="vat_number" value=""/>
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <b>Tin Number:</b><input type="file" name="tin_number" id="file" placeholder="file"/>
				 <br><br><b>Trade Licens</b><input type="file" name="Trade Licens</" id="file" placeholder="file"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <b>C.P.O</b><input type="file" name="Trade Licens</" id="file" placeholder="file"/>
				<br> <br><b>Item-Type:</b><input type="text" name="item-type" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <b>Item-Model:</b><input type="text" name="item-model" value=""/>
				 <br><br><b>Unit-Price:</b><input type="text" name="Unit-Price" VALUE="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Quantity:</b><input type="text" name="quantity" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<b>Date:</b>
...
function drawHand(ctx, pos, length, width) {
	...
	<h3>Help</h3>
		<ul>
			<li>1.&nbsp; &nbsp;To use this system the suplier must be rigister and win </li><hr>
			<li>2.&nbsp; &nbsp;To knowe the system click tages in the above</li><hr>
			<li>3.&nbsp; &nbsp; Fill registration form fully<li><hr>
			<li>4.&nbsp; &nbsp; Should not fill error message</li><hr>
			<li>5.&nbsp; &nbsp;<a href="contactus.php"> For mor information...</a>
			</li>
