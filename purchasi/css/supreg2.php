...
<legend align="center"><h2 class="style12"> የተጫራች መመዝገቢያ ቅጽ</h2></legend>  
		...
		<form><br>
			<b>ስም：&nbsp;&nbsp;&nbsp;</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="" >
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<b>የአባት ስም ：</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="" ><br>
				<br><b>የድርጅት ስም：&nbsp;&nbsp;&nbsp;&nbsp;</b><input type="text" value="" >
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<b>
				<b>ጾታ：</b><input type="radio" name="supplier_sex" value="male"/> ወንድ
                 <input type="radio" name="supplier_sex"  value="female"/> ሴት&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 <br><b> <br>ሀገር：</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="role"required="true"><br>
								...
								<b>ከተማ：</b><input type="text" name="city" value=""/>	
				 <br> <br><b>ስልክ：</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="supplier_phone" pattern="[09]{2}[0-9]{8}" required id="phone" />
				   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				   <B>ኢሜይል：</B><input type="text" id="email" name="email" required=""  /> <br>
				 <br><b>የግብር መለያ ቁጥር：</b><input type="text" name="የግብር መለያ ቁጥር" value=""/>
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <b>መለያ ቁጥር:</b><input type="file" name="መለያ ቁጥር" id="file" placeholder="file" value="ምረጥ"/>
				  <br><br><b>ንግድ ፈቃድ：</b><input type="file" name="ንግድ ፈቃድ" id="file" placeholder="file"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <b>ማሲያዣ：</b><input type="file" name="ንግድ ፈቃድ" id="file" placeholder="file"/>
				  <br><br><b>የቃው አይነት：</b><input type="text" name="item-type" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <b>የቃው ሞዴል：</b><input type="text" name="item-model" value=""/>
				  <br><br><b>የአንዱ ዋጋ:</b><input type="text" name="item-model" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <b>የቃብዛት：</b><input type="text" name="quantity" value=""/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <b>ቀን：&nbsp;&nbsp;&nbsp;</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <input type="text" name="sdate" value="<?php echo date('Y/m/d');?>" required="" />
...
function drawHand(ctx, pos, length, width) {
	...
	<h3>አጋዥ</h3>
		<ul>
			...
			<li>5.&nbsp; &nbsp;<a href="contactus.php"> ለበለጠ መረጃ...</a>
			</li>
