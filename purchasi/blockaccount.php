...
echo "<td>".$row['username']."</td>";
	...
	echo "<td>".$row['status']."</td>";
     ...
     <script>
		...
		echo'<form action="blockaccount.php" method="POST">';
 ...
 if(isset($_POST['block']))
{
 ...
 $sql3=" update account set status='inactive' where empl_id='$empl_id'";  
          ...
          If($result){
           echo "<font color='green' size='5'>account is blocked successfully!</font>";
		 }
		 else
           die("<font color='red' size='5'>account is not blocked:</foont>".mysqli_error($connection));  
}
  ?>
