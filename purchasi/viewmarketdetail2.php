...
<div id="left"><h2>በገበያ ጥናት ቡድን የተጠናውን የገበያ ዝርዝር እይ</h2>
<div>
...
If($connection){
		...
		If($sql){
             $sql2="select * from marketdetail";                            
              $result=mysqli_query($connection,$sql2) ;
          If($result){
echo "<table  border=1 cellpadding=5 id='tb'><tr><th>የገበያ ዝርዝር መለያ</th>";
echo "<th>የትእዛዝ መለያ</th><th>ያንዱዋጋ</th><th>የተጠናበት ቀን</th></tr>";
	While($row=mysqli_fetch_array($result))
	{     echo "<tr><td>".$row['marketdetail_id']."</td>";
echo "<td>".$row['request_id']."</td>";
	echo "<td>".$row['unit_price']."</td>";
		echo "<td>".$row['studied_date']."</td>";
		?>
		<script>
	...
	echo "</table>";
       ...
       die("<font color='red' size='5'>ኮነክሽን ተቋርጧል: </font>".mysqli_error($connection));
 }
