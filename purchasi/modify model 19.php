...
<fieldset>
	<legend align="center"><h2>modify model19 here</h2></legend><br>
	&nbsp;&nbsp;&nbsp;reciept number:<input type="text" name="recieving_reciept_no" required=""/><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;quantity:<input type="text" name="quantity" required="" /><br><br>



&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" name="insert" >modify</button>
...
If($result)
			echo "<font color='green' size='5'>model19 is modified successfully!</font>";
		else
 die("<font color='red' size='5'>model19 is not modified</font>".mysqli_error($connection));
		}  else
