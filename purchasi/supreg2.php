...
<?php include("listt.php");?>
     ...
     <div id="templatemo_main">
         <div id="sidecon">
       <div id="left">
       <h2>የተጫራች መመዝገቢያ ቅጽ</h2>
         

<form  id="email_form" action="supreg2.php" enctype="multipart/form-data" onsubmit="javascript:return validate('email_form','email');" method="post"><br><br>
<b>የጨረታ መለያ:</b><input type="text" name="id">
      <b>ስም：</b><input type="text" value="" name="supplier_fname" required id="" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <b>የአባት ስም：</b><input type="text" value="" name="supplier_lname" required id="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      
        <br><br>
<b>ድርጅት ስም：</b><input type="text"  name="company" required id="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        
            
                 <b> አገር：</b><select name="country"required="true">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ከተማ：</b><input type="text" name="city" value="" required id=""/> <br><br>

         <b>ስልክ ቁጥር：</b><input type="text" name="supplier_phone" pattern="[09]{2}[0-9]{8}" required id="phone" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <B>ኢሜል：</B><input type="text" id="email" name="email" required=""  /> 
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ግብር ቁጥር:<input  type="text" name="vat_registration_number"required="" />
        <br><br>  <b>ጾታ：</b><select type="text" name="supplier_sex"><option>male</option>  
                 <option>female</option></select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;መለያ ቁጥር<input type="file" name="tin_number" id="file" placeholder="file"/>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ንግድ ፈቃድ:<input type="file" name="trade_license" id="trade_license">
          <br><br><b>ሲፒኦ：</b><input type="file" name="cpo" id="file" placeholder="file" required id=""/>
         የእቃ አይነት:<input type="text" name="item_type" pattern="[A-Za-z]+"  required/>  &nbsp;&nbsp;&nbsp;  ቀን:<input type="date" name="registereddate" value="<?php echo date('Y-m-d');?>"/> <br><br >የቃው ሞዴል:<input type="text" name="item_model" pattern="[0-9A-Za-z]+" required/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>የአንዱ ዋጋ:<input type="text" name="unit_price" pattern="[0-9]+" required/> ብዛት:<input type="text" name="quantity" pattern="[0-9]+" required/><br><br>
            
             <center> <button type="submit" style="background-color: #005580;  border:2px solid #cccccc; box-sizing: border-box; padding: 0px;" name="app">ተመዝገብ</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button type="submit" style="background-color: #005580;  border:2px solid #cccccc; box-sizing: border-box; padding: 0px;" >ሰርዝ</button></center>
...
$mysql=mysqli_query($con,"INSERT into supplier(id,supplier_fname,supplier_lname,supplier_sex,campany,country,city,supplier_phone,email,item_type,item_model,quantity,unit_price,total_price,tin_number,trade_license,vat_registration_number,cpo,registereddate,status)values('$id','$supfname','$suplname','$supplier_sex','$company','$country','$city','$phone','$email','$item_type','$item_model','$quantity','$unit_price','$total_price','$image','$images','$imagees','$vat_registration_no','$registereddate', '$status')");
if($mysql) {
...
<div id="right">
  ...
  <h3>Instruction</h3><HR>
    <ul>
      <li>1.&nbsp; &nbsp;ንግድ ፈቃድ አስገቡ</li><hr><br>
      <li>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 2.&nbsp; &nbsp;ንግድ መለያ ቁጥር ያስገቡ</li><hr><br>
      <li>3.&nbsp; &nbsp; መለያ ቁጥር ያስገቡ<li><hr><br>
      <li>4.&nbsp; &nbsp;ሲፒኦ ያስገቡ &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  </li><hr><br>
...
<div id="contents">
  <center><p style="margin-left: 40px "><b><i>ማሳሰቢያ：ሁሉንም በጥንቃቄ ይሙሉ<i></p><center>
</div>
<div id="fotter">
