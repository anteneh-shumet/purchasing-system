...
<div id="right">
  	...
  	<button class="dropbtn1" font-size="200px">ኮሌጅ አድሚንስትሬተር</button></center><br
...
If($result){
	...
	echo "<font color='green' size='5'>እቃ የማስለቀቅ ጥያቄው በትክክል ተልኳል</font>";
}
	else
		echo"<font color='red' size='5'>እቃ የማስለቀቅ ጥያቄው አልተላከም </font>";
	}
 ...
 die("<font color='red' size='5'>at first you request &nbsp;&nbsp;&nbsp;".$q."&nbsp;&nbsp;&nbsp;". $i."&nbsp;&nbsp;items <br>please request that you submit while you request purchasing </font>".mysqli_error($connection));
	...
	echo "<font color='red' size='5'>ቅድም የላኩት የግዥ ጥያቄ በገምጋሚ ቡድኑ ተቀባይነት አላገኘም </font>";
	}
