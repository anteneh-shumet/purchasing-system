...
<div>
<form id="form"action="registeringmodel20.php" method="post" form name="f1" align="center">
<fieldset>
...
If($result){
	...
	echo "<font color='red' size='5'> item withdraw requistion is  sent successfully! </font>";
}
	else
 ...
 echo" <font color='red' size='5'> at first you request &nbsp;&nbsp;&nbsp;".$q."&nbsp;&nbsp;&nbsp;". $i."&nbsp;&nbsp;items <br>please request that you submit while you request purchasing </font>".mysqli_error($connection);

		}
		else
	echo "<font color='red' size='5'>the purchasing request you sent previous was rejected by approval commite </font>";
	}
