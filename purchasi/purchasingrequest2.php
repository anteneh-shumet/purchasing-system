...
<div id="left">
<div>
<form id="form"action="purchasingrequest2.php" method="post" form name="f1" align="center"><fieldset>
<legend align="center"><h2>የግዥ ትእዛዝ መላኪያ ቅጽ</h2></legend><br>
&nbsp;item_type:<input type="text" name="item_type" placeholder="enter item type"pattern="[a-zA-Z0-9]+" required />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ላኪ:<select name="sent_from"required="true"  pattern="[A-Z a-z]+" >
