...
<fieldset>
	<legend><h2>የገበያ ዝርዝር</h2></legend><br>
...
If($result)
			echo "<font color='green' size='5'>የገበያ ዝርዝር በትክክል ተመዝግቧል! </font>";
		else
 echo("<font color='red' size='5'>የገበያ ጥናቱ አልተመዘገበም! </font>".mysqli_error($connection));
		}  else
