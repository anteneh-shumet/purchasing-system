...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>item_type:<input type="text" name="item_type" placeholder="enter item type"pattern="[a-zA-Z0-9]+" required />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status:<select name="sent_from" required="true"  pattern="[A-Z a-z]+" >
