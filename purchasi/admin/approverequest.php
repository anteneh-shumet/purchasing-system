...
echo "<th>item</th><th>model</th><th> quantity</th><th> office</th><th>college</th><th>department</th><th>action</th><th>reaction</th></tr>" ;
 ...
 if(isset($_POST['approve']))
{
 ...
 $sql3=" update request set status='approved' where request_no='$request_id'";  
          ...
          If($result){
           echo "request is approved successfully!";
		 }
		 else
           die("request is not approved:".mysqli_error($connection));  
}
 if(isset($_POST['reject']))
{
 ...
 $sql3=" update request set status='not approved' where request_no='$request_id'";  
              $result=mysqli_query($connection,$sql3) ;
          If($result){
           echo "request is rejected successfully!";
		 }
		 else
           die("request is not rejected:".mysqli_error($connection));  
}
  ?>
