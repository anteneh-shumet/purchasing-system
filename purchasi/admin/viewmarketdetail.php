...
<div id="left"><h2>view market detail studied by market study team</h2>
<div>
...
If($connection){
		...
		If($sql){
          ...
          If($result){
echo "<table  border=1 cellpadding=5 id='tb'><tr><th>marketdetail_id</th>";
echo "<th>request_id</th><th>unit_price</th><th>studied_date</th></tr>";
