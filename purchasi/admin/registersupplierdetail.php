...
$mysql=mysqli_query($con,"insert into supplier values('$id','$supfname','$suplname','$supplier_sex','$phone','$email','$item_type','$item_model','$quantity','$unit_price','$total_price','$image','$images','$vat_registration_no','$registereddate','$status')");
if($mysql)	
echo "you have sucessfully apply for the tender";	
			}
		else
