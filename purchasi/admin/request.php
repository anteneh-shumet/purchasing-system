...
<a href="request.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;request purchasing </a><br><hr>
 <a href="registeringmodel20.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;register model20 </a><br><hr>
  <a href="viewdirectoratenotice.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;view directorate notices </a><br><hr>
...
&nbsp;item_type:<input type="text" name="item_type" placeholder="enter item type"pattern="[a-zA-Z0-9]+" required />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status:<select name="sent_from"required="true"  pattern="[A-Z a-z]+" >
<option value="offices">offices</option>
</select><br><br>
&nbsp;&nbsp;&nbsp;specification:<input type="text" name="specification" placeholder="enter  items specification"pattern="[a-zA-Z0-9]+" required />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;office_id:<input type="text" name="officce_id" placeholder="enter office number"pattern="[a-zA-Z0-9]+" required /><br><br>
item_quantity:<input type="text" name="item_quantity" placeholder="enter item quantity"pattern="[0-9]+" required />
&nbsp;&nbsp;&nbsp;&nbsp;dept name:<select name="dept_name"required="true"  pattern="[A-Z a-z]+" ><br>
