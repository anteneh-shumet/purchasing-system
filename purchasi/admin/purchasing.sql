...
--
-- Host: localhost
-- Generation Time: Jun 05, 2019 at 12:55 AM
...
-- Database: `purchasing`
--
CREATE DATABASE IF NOT EXISTS `purchasing` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `purchasing`;
...
('emp10', 'abinet', '75ca9414bd3383b7d85ba42af7e8fe52', 'finance officer', 'active'),
