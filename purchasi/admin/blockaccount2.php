...
<button class="dropbtn1">አስተዳደር</button><br
  ...
  <a href="registeringemployee.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ሰራተኛ መዝግብ</a><br><hr>
<a href="createacount.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;አካውንት ክፈት </a><br><hr>
<a href="registeringcolleges.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ኮሌጆችን መዝግብ </a><br><hr>
<a href="registeringdepartments.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ዲፓርትመንት መዝግብ</a><br><hr>
<a href="registeringoffices.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ቢሮዎችን መዝግብ </a><hr>
  </div>
...
If($connection){
		...
		If($sql){
            $sql2="select * from account where status='active'";                            
...
echo "<td>".$row['username']."</td>";
	...
	echo "<td>".$row['status']."</td>";
     ...
     <script>
		...
		echo'<form action="blockaccount2.php" method="POST">';
echo'<td><input type="submit" name="block" value="block"/></td><tr>';
 ...
 if(isset($_POST['block']))
{
 ...
 $sql3=" update account set status='inactive' where empl_id='$empl_id'";  
              $result=mysqli_query($connection,$sql3) ;
          If($result){
           echo "አካውንቱ ተዘግቷል!";
		 }
		 else
           die("አካውንቱ አልተዘጋም:".mysqli_error($connection));  
}
  ?>
