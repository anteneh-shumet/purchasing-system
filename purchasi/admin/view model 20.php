...
If($connection){
		...
		If($sql){
             $sql2="select * from model20";                            
              $result=mysqli_query($connection,$sql2) ;
          If($result){//Displaying the values using a table
echo "<table border=1 id='tb' cellpadding=10><tr>";
echo "<th>id</th><th>requester</th><th>deliverer</th><th>item_type</th><th>specification</th><th>quantity</th><th>date</th></tr>";
	While($row=mysqli_fetch_array($result))
	{     
echo "<tr><td>".$row['withdraw_requistion_no']."</td>";
echo "<td>".$row['requester_body']."</td>";
	echo "<td>".$row['officers_name']."</td>";
