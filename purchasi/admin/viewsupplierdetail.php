 ...
 if(isset($_POST['approve']))
{
 ...
 $sql3=" update supplier set status='accepted' where id='$id'";  
          ...
          If($result){
           echo "supplier detail is accepted!";
		 }
		 else
           die("supplier detail is not accepted".mysqli_error($connection));  
}
if(isset($_POST['reject']))
{
 ...
 $sql3=" update supplier set status='rejected' where id='$id'";  
              $result=mysqli_query($connection,$sql3) ;
          If($result){
           echo "supplier detail is rejected!";
		 }
		 else
           die("supplier detail is not rejected".mysqli_error($connection)); 
