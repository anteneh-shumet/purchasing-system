...
<div>
<form id="form"action="requesting.php" method="post" form name="f1" align="center">
<fieldset>
<legend align="center"><h2>purchasing request submission form</h2></legend>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>item_type:<input type="text" name="item_type" placeholder="enter item type"pattern="[a-zA-Z0-9]+" required />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status:<select name="sent_from"required="true"  pattern="[A-Z a-z]+" >
...
&nbsp;college name:<select name="colleg_name"required="true"  pattern="[A-Z a-z]+" ><br><br>
					<option>choose</option>
