...
&nbsp;&nbsp;&nbsp;&nbsp;studied_date:<input type="text" name="studied_date" required="" /><br><br>
...
//  Updating record
 ...
 $sql2=" update marketdetail set request_id='$request_id',unit_price='$unit_price',studied_date='$studied_date' where marketdetail_id='$marketdetail_id'";                            
          ...
          If($result){
           echo "market detail successfully updated!";
		 }else
           die("market detail is  Not updated:".mysqli_error($connection));  
       }  else
