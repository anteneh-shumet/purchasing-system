...
<div>
<form   id="form"action="registeringdepartments2.php"  method="post">
<h2 class="style12">
       <center>የዲፓርትመንቱ መመዝገቢያ ቅጽ</center></h2><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;የዲፓርትመንቱ ስም:<select name="department_name"required="true"  pattern="[A-Z a-z]+" ><br>
					<option>ይምረጡ</option>
...
የዲፓርትመንቱ መሪ ስም:<input type="text" name="department_head_fname" pattern="[A-Za-z]+" required/><br><br>
 የዲፓርትመንቱ መሪ የአባት ስም:<input type="text" name="department_head_lname" pattern="[a-zA-Z]+" required/><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ኮለጅ ስም:<select name="college_name"required="true"  pattern="[A-Z a-z]+" ><br>
					<option>ይምረጡ</option>
...
If($result)
		echo "<font color='green' size='5'>ዲፓርትመንቱ ተመዝግቧል </font>";}
		else
 echo"<font color='red' size='5'>ዲፓርትመንቱ በዚህ ኮሌጅ ስር አደለም </font>";
		}  else
