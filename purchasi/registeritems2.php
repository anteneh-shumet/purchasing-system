...
<fieldset>
	<legend><h2>ኮድ 10 መዝግብ</h2></legend><br><br>
	ደረሰኝ ቁጥር:<input type="text" name="recieving_reciept_no" required=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ሞዴል:<input type="text" name="model" required="" /><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ኧአስረካቢ:<input type="text" name="deliverer" required=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ብዛት:<input type="text" name="quantity" required="" /><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ተቀባይ:<input type="text" name="reciepant" required="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ያንዱ ዋጋ:<input type="text" name="unit_price" required="" />	<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;የትእዛዝ ቁጥር:<input type="text" name="order_no" required="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;የእቃ አይነት:<input type="date" name="item_type" required="" /><br><br>	
...
If($result)
			echo "<font color='green' size='5'>ሞዴል 19 በትክክል ተመዝግቧል </font>";
		else
 die("<font color='red' size='5'>መረጃው አልተመዘገበም").mysqli_errno($con);
		}  else
