...
echo "<table border=1 cellpadding=20 id='tb'><tr><th>office-id</th>";
echo "<th>college-name</th><th>dept-name</th></tr>" ;
	While($row=mysqli_fetch_array($result))
	{     
echo "<tr><td>".$row['office_id']."</td>";
	echo "<td>".$row['colege_name']."</td>";
	echo "<td>".$row['department_name']."</td><tr>";
	?>
	<script>
